...
In this paper, we deal with the specific case of \emph{stochastic time delays} i.e. time delays which vary randomly. There appears to be little existing research on this exact topic.
...
$\beta$ & 2.09 & 0.5 & 2  \\
\hline
$Intercept$ & 6.53 & 6.62 & 6.5 \\
\hline
$\lambda_{\tau}$ & 1.54 & $N/A$ & 1.4 \\
\hline
$\sigma_{\epsilon}$ & 0.20 & 1.03 & 0.2 \\
\end{tabular}
\caption{ ... } 
\label{results_table}
\end{table}
